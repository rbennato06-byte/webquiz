...
{ id:"agg-07", topic:"aggregazione", type:"mc",
  ...
  options:[
    ...
    "Esclusivamente dalla pressione atmosferica",
...
{ id:"agg-13", topic:"aggregazione", type:"mc",
  ...
  options:[
    ...
    "È costituito solo da ioni",
    "Ha una temperatura di fusione netta",
    "È sempre anisotropo"], correct:0 },
...
{ id:"agg-14", topic:"aggregazione", type:"mc",
  ...
  options:[
    ...
    "Assenza di periodicità nel reticolo",
    "Punti di fusione molto bassi",
    "Una nuvola di elettroni delocalizzati come nei metalli"], correct:1,
...
{ id:"agg-16", topic:"aggregazione", type:"mc",
  ...
  options:[
    ...
    "Nessuna forza: sono libere di muoversi",
    "Legami ionici",
    "Legami covalenti a rete"], correct:1,
...
{ id:"agg-19", topic:"aggregazione", type:"mc",
  ...
  options:[
    ...
    "Atomi metallici immersi in una nuvola elettronica"], correct:1 },
...
{ id:"gas-11", topic:"gas", type:"mc",
  ...
  options:[
    "1 mmol di qualunque gas alle condizioni standard",
    "1 kg di azoto liquido",
    "1 mole di azoto liquido",
    "1 mole di qualunque gas alle condizioni standard (0°C, 1 atm)",
    "1 kg di acqua allo stato di vapore"], correct:3 },
...
{ id:"gas-17", topic:"gas", type:"mc",
  ...
  options:[
    ...
    "Coincide con il volume molare",
    "È sempre costante indipendentemente dal gas",
    "È trascurabile rispetto al volume totale occupato dal gas",
    "È uguale al volume totale del gas"], correct:3,
...
{ id:"liq-09", topic:"liquido", type:"mc",
  ...
  options:[
    ...
    "Il punto di massima densità di una sostanza",
    "Il punto in cui la tensione superficiale è nulla",
    "Le condizioni in cui il liquido bolle"], correct:1 },
...
{ id:"liq-11", topic:"liquido", type:"mc",
  ...
  options:[
    "La sostanza si decompone chimicamente",
    "Non esiste più distinzione tra fase liquida e gassosa: si parla di fluido supercritico",
    "La tensione di vapore diventa nulla",
    "Coesistono sempre le tre fasi",
    "La sostanza diventa sempre solida"], correct:1 },
...
{ id:"liq-12", topic:"liquido", type:"mc",
  ...
  options:[
    ...
    "È un errore: la curva ha sempre pendenza positiva",
    ...
    "Perché l'acqua non ha un punto triplo"], correct:2 },
...
{ id:"liq-13", topic:"liquido", type:"mc",
  ...
  options:[
    ...
    "Nessun cambiamento di fase"], correct:3 },
...
{ id:"liq-15", topic:"liquido", type:"mc",
  ...
  options:[
    ...
    "La pressione di vapore è nulla in superficie",
    "Le molecole in superficie non subiscono alcuna forza intermolecolare",
    "Il liquido perde continuamente massa dalla superficie"], correct:1 },

{ id:"liq-16", topic:"liquido", type:"mc",
  q:"L'effetto della tensione superficiale su un liquido è quello di:",
  options:[
    "Ridurre a zero il volume del liquido",
    "Annullare le forze di coesione tra le molecole",
    "Creare uno strato superficiale simile a un film elastico, che tende a contrarsi ed è difficile da penetrare",
    "Espandere la superficie del liquido il più possibile",
    "Aumentare la comprimibilità del liquido"], correct:2 },
...
{ id:"liq-26", topic:"liquido", type:"mc",
  ...
  options:[
    ...
    "Il calore necessario per vaporizzare un grammo di liquido",
    "Il rapporto tra la massa e il volume del liquido",
    "La pressione esercitata dal vapore in equilibrio col liquido",
...
{ id:"liq-27", topic:"liquido", type:"mc",
  ...
  options:[
    "Aumentano la coesione tra le molecole d'acqua",
    "Reagiscono chimicamente con l'acqua formando un nuovo composto",
    "Non hanno alcun effetto sulla superficie del liquido",
    "Aumentano la viscosità del liquido",
...
{ id:"liq-28", topic:"liquido", type:"mc",
  ...
  options:[
    ...
    "La densità del liquido e la gravità soltanto",
    "Le forze di coesione (liquido-liquido) e le forze di adesione (liquido-parete)",
    "La sola temperatura del liquido"], correct:3 },
...
{ id:"liq-29", topic:"liquido", type:"mc",
  ...
  options:[
    ...
    "Non risale né scende nel capillare",
    "Forma un menisco piatto",
    "Evapora immediatamente"], correct:0 },

{ id:"liq-30", topic:"liquido", type:"mc",
  q:"Nel caso del mercurio in un tubo di vetro, dove la coesione supera l'adesione, il liquido:",
  options:[
    "Risale indefinitamente nel capillare",
    "Si comporta esattamente come l'acqua",
    "Bagna la parete e forma un menisco concavo",
    "Non risente affatto della parete del tubo",
...
{ id:"liq-33", topic:"liquido", type:"mc",
  ...
  options:[
    ...
    "Una viscosità molto elevata",
    "Una densità molto alta",
    "Una bassissima tensione di vapore"], correct:0 },
...
{ id:"liq-34", topic:"liquido", type:"mc",
  ...
  options:[
    "Il colore della sostanza",
    "La sola pressione esterna",
    "La sola massa molecolare",
    "La sola forma della molecola",
...
{ id:"liq-35", topic:"liquido", type:"mc",
  ...
  options:[
    ...
    "Una tensione di vapore più alta"], correct:3 },
...
{ id:"liq-36", topic:"liquido", type:"mc",
  ...
  options:[
    "Nessuna differenza nelle proprietà fisiche",
    "Un punto di ebollizione più basso",
    "Un punto di ebollizione più alto, per la maggiore superficie di contatto disponibile per le interazioni di London",
    "La stessa tensione di vapore della molecola compatta",
    "Una minore massa molecolare"], correct:2 },
...
{ id:"mis-10", topic:"misure", type:"mc",
  ...
  options:[
    ...
    "È sempre meno precisa di una misura indiretta",
    "Si ottiene sempre con uno strumento elettronico"], correct:2 },

{ id:"mis-11", topic:"misure", type:"mc",
  q:"Una misura si dice indiretta quando:",
  options:[
    "Non può mai essere espressa con cifre significative",
    ...
    "Coincide sempre con una misura diretta"], correct:2,
...
{ id:"mis-12", topic:"misure", type:"mc",
  ...
  options:[
    ...
    "Eliminare la necessità delle unità di misura",
...
{ id:"mis-25", topic:"misure", type:"mc",
  ...
  options:[
    "Indipendente dall'angolo tra i due vettori",
    "La somma dei moduli di A e B",
    "Sempre nullo se A e B sono paralleli o antiparalleli",
    "$|\\vec{A}\\times\\vec{B}|=AB\\sin\\theta$, con θ l'angolo compreso tra i due vettori",
    "$AB\\cos\\theta$"], correct:3 },
...
{ id:"mis-27", topic:"misure", type:"mc",
  ...
  options:[
    ...
    "Sempre diretto lungo l'asse z",
    "Indipendente dai moduli dei vettori"], correct:2 },
...
{ id:"mis-28", topic:"misure", type:"mc",
  ...
  options:[
    ...
    "Il risultato diventa uno scalare",
    "Il modulo del vettore risultante cambia"], correct:1 },
...
{ id:"cin-01", topic:"cinematica", type:"mc",
  ...
  options:[
    ...
    "Esclusivamente le forze agenti su un corpo",
    "Le cause del moto dei corpi",
    "L'equilibrio dei corpi fermi"], correct:1 },

{ id:"cin-02", topic:"cinematica", type:"mc",
  q:"La traiettoria di un punto materiale è definita come:",
  options:[
    "La velocità media del punto",
    "L'accelerazione subita dal corpo",
    "L'insieme dei punti dello spazio occupati dal punto materiale durante il suo moto",
    "Il tempo impiegato a percorrere un tragitto",
    "La distanza percorsa nel tempo"], correct:2 },
...
{ id:"cin-04", topic:"cinematica", type:"mc",
  ...
  options:[
    ...
    "La traiettoria del corpo in esame",
    "Un tipo particolare di moto",
    "La velocità istantanea del corpo"], correct:1 },
...
{ id:"cin-06", topic:"cinematica", type:"mc",
  ...
  options:[
    "Il prodotto tra la massa e la posizione",
    "Il prodotto tra spazio percorso e tempo impiegato",
    "Il rapporto tra tempo e spazio percorso",
    "Il rapporto tra lo spazio percorso $\\Delta s$ e l'intervallo di tempo $\\Delta t$ in cui è stato percorso",
    "Il rapporto tra accelerazione e tempo"], correct:3 },
...
{ id:"cin-09", topic:"cinematica", type:"mc",
  ...
  options:[
    ...
    "Accelerazione costante e diversa da zero",
    "Velocità che varia linearmente nel tempo",
    "Traiettoria circolare"], correct:1 },
...
{ id:"cin-10", topic:"cinematica", type:"mc",
  ...
  options:[
    ...
    "Lo spazio totale percorso"], correct:3 },
...
{ id:"cin-12", topic:"cinematica", type:"mc",
  ...
  options:[
    "Il rapporto tra forza e tempo",
    "Il rapporto tra la variazione di velocità $\\Delta v$ e l'intervallo di tempo $\\Delta t$ in cui avviene",
    "Il prodotto tra velocità e tempo",
    "La variazione di posizione nel tempo",
    "Il rapporto tra spazio percorso e tempo"], correct:1 },
...
{ id:"cin-14", topic:"cinematica", type:"mc",
  ...
  options:[
    ...
    "La velocità è sempre nulla",
    "La traiettoria è una parabola",
    "L'accelerazione varia nel tempo"], correct:1 },
...
{ id:"cin-29", topic:"cinematica", type:"mc",
  ...
  options:[
    "Un moto circolare uniforme composto con un MRU",
    "Un unico moto uniformemente accelerato lungo la traiettoria",
    "Un moto orizzontale a velocità costante (MRU) e un moto verticale uniformemente accelerato dalla sola gravità",
    "Due moti rettilinei uniformi identici",
    "Due moti uniformemente accelerati identici lungo x e y"], correct:2 },
...
{ id:"cin-34", topic:"cinematica", type:"mc",
  ...
  options:[
    ...
    "$R=\\dfrac{v_0\\cos\\theta_0}{g}$",
    "$R=\\dfrac{v_0^2}{g}$",
    "$R=v_0^2\\sin\\theta_0$"], correct:1 },
...
{ id:"cin-36", topic:"cinematica", type:"mc",
  ...
  options:[
    "Producono sempre gittate diverse",
    "Non hanno alcuna relazione tra loro",
    "Sono equivalenti in ogni aspetto del moto, incluso il tempo di volo",
    "Producono sempre la stessa altezza massima",
...
{ id:"cin-38", topic:"cinematica", type:"mc",
  ...
  options:[
    "Infinito, se la velocità orizzontale è molto alta",
    "Uguale a $\\sqrt{h/g}$",
    "Uguale a $h/g$",
    "$t_f=\\sqrt{2h/g}$, indipendente dalla velocità orizzontale di lancio",
    "Che dipende dalla velocità orizzontale di lancio"], correct:3,
...
{ id:"cin-39", topic:"cinematica", type:"mc",
  ...
  options:[
    ...
    "La pallina lanciata orizzontalmente tocca il suolo prima",
    "La pallina lasciata cadere tocca il suolo prima",
    "Il risultato dipende dalla massa delle due palline",
    "Nessuna delle due tocca mai il suolo"], correct:0 },
...
{ id:"cin-42", topic:"cinematica", type:"mc",
  ...
  options:[
    ...
    "$\\omega=\\pi T$",
    "$\\omega=\\dfrac{T}{2\\pi}$",
    "$\\omega=\\dfrac{1}{2\\pi T}$"], correct:0 },
...
{ id:"cin-44", topic:"cinematica", type:"mc",
  ...
  options:[
    ...
    "$a_c=\\dfrac{v}{r^2}$",
    "$a_c=\\dfrac{r}{v^2}$",
    "$a_c=\\omega r$ soltanto"], correct:0 },
...
{ id:"din-01", topic:"dinamica", type:"mc",
  ...
  options:[
    "L'energia meccanica si conserva sempre, anche in presenza di attrito",
    ...
    "Ad ogni azione corrisponde una reazione uguale e contraria"], correct:2 },
...
{ id:"din-03", topic:"dinamica", type:"mc",
  ...
  options:[
    ...
    "La quantità di moto totale di un sistema aumenta nel tempo"], correct:3 },
...
{ id:"din-09", topic:"dinamica", type:"mc",
  ...
  options:[
    "È una quantità vettoriale espressa in newton",
    "Dipende dall'accelerazione di gravità del luogo",
    "È una proprietà intrinseca del corpo e non varia con la posizione",
    "Si misura in newton",
    "Aumenta quando il corpo accelera"], correct:2 },
...
{ id:"din-14", topic:"dinamica", type:"mc",
  ...
  options:[
    "La sua accelerazione è massima",
    "La sua velocità è massima",
    "La sua massa è nulla",
    "È soggetto a una sola forza",
...
{ id:"din-30", topic:"dinamica", type:"mc",
  ...
  options:[
    "Non dipende in alcun modo dalla distanza dal centro del pianeta",
    "Dipende dal pianeta considerato e dalla distanza dal suo centro, ma non dalla massa dell'oggetto che cade",
    "Dipende dalla massa dell'oggetto che cade: un corpo più pesante accelera di più",
    "È una costante universale identica su ogni pianeta",
    "Dipende solo dalla forma dell'oggetto che cade"], correct:1,
...
{ id:"en-03", topic:"energia", type:"mc",
  ...
  options:[
    "Il lavoro $L$ è negativo",
    "$F$ e $s$ sono perpendicolari",
    "L'angolo $\\alpha$ è ottuso",
    "L'angolo $\\alpha$ è acuto (o nullo) e quindi $L$ è positivo",
    "Il lavoro $L$ è sempre nullo"], correct:3 },
...
{ id:"en-04", topic:"energia", type:"mc",
  ...
  options:[
    ...
    "Lo spostamento $s$ è nullo",
    "$F$ e $s$ sono paralleli e concordi",
    "L'angolo tra $F$ e $s$ è acuto",
    "La forza $F$ è nulla"], correct:0 },

{ id:"en-05", topic:"energia", type:"mc",
  q:"La potenza è definita come:",
  options:[
    "La variazione di energia cinetica",
    "Il prodotto tra lavoro e tempo",
    "Il prodotto tra forza e velocità al quadrato",
    "Il rapporto tra il lavoro compiuto e l'intervallo di tempo impiegato",
    "Il rapporto tra forza e spostamento"], correct:3 },
...
{ id:"atom-11", topic:"atomo", type:"mc",
  ...
  options:[
    ...
    "Un diverso numero atomico"], correct:2 },
...
{ id:"atom-18", topic:"atomo", type:"mc",
  ...
  options:[
    ...
    "Tutti gli elettroni devono avere spin parallelo",
...
{ id:"atom-19", topic:"atomo", type:"mc",
  ...
  options:[
    ...
    "Solo negli orbitali s",
    "Sempre a coppie con spin antiparallelo"], correct:0 },
...
{ id:"atom-25", topic:"atomo", type:"mc",
  ...
  options:[
    "La traiettoria esatta di un elettrone attorno al nucleo",
    "Un particolare tipo di legame chimico",
    ...
    "Il nucleo dell'atomo"], correct:2 },
...
{ id:"atom-33", topic:"atomo", type:"mc",
  ...
  options:[
    ...
    "Solo i composti organici obbediscono a questa legge",
    "La massa totale del composto è sempre uguale a quella di un solo elemento",
    "Il rapporto di massa tra gli elementi varia a seconda di come il composto viene preparato",
    "Gli elementi possono combinarsi in qualsiasi rapporto di massa"], correct:0,
...
{ id:"atom-34", topic:"atomo", type:"mc",
  ...
  options:[
    "Solo il primo composto formato rispetta rapporti definiti",
    ...
    "Le masse dei due elementi sono sempre uguali in tutti i composti",
    "Il rapporto di massa è sempre 1:1",
    "Non esiste alcuna relazione numerica tra le masse dei composti diversi"], correct:1,
...
{ id:"atom-35", topic:"atomo", type:"mc",
  ...
  options:[
    "Identici agli atomi di qualunque altro elemento",
    ...
    "Tutti diversi tra loro per massa",
    "Privi di massa propria"], correct:1 },
...
{ id:"atom-36", topic:"atomo", type:"mc",
  ...
  options:[
    ...
    "Vengono sempre creati dal nulla",
    "Vengono sempre distrutti completamente",
    "Cambiano identità elementare durante la reazione",
    "Si dividono sempre in particelle subatomiche"], correct:0 },

{ id:"atom-37", topic:"atomo", type:"mc",
  q:"Thomson, studiando i raggi catodici, scoprì l'elettrone osservando che questi raggi:",
  options:[
    "Avevano sempre carica positiva",
    "Erano costituiti da fotoni privi di massa",
    "Non erano mai influenzati da campi elettrici",
    "Erano visibili solo nel vuoto assoluto, senza alcuna deviazione possibile",
...
{ id:"atom-38", topic:"atomo", type:"mc",
  ...
  options:[
    ...
    "Un insieme di orbitali a forma definita attorno a un nucleo",
    "Un nucleo centrale piccolissimo circondato da elettroni orbitanti a grande distanza",
    "Una particella indivisibile priva di struttura interna",
...
{ id:"atom-39", topic:"atomo", type:"mc",
  ...
  options:[
    "Le particelle venivano assorbite completamente dalla lamina",
    ...
    "Tutte le particelle attraversavano la lamina senza alcuna deviazione",
    "Tutte le particelle rimbalzavano indietro",
    "Le particelle si trasformavano in elettroni durante l'attraversamento"], correct:1 },
...
{ id:"atom-40", topic:"atomo", type:"mc",
  ...
  options:[
    ...
    "Il nucleo occupa la maggior parte del volume atomico",
    "La carica positiva è distribuita uniformemente in tutto l'atomo",
    "L'atomo non ha alcuna struttura interna",
    "Gli elettroni si trovano all'interno del nucleo, insieme ai protoni"], correct:0,
...
{ id:"atom-41", topic:"atomo", type:"mc",
  ...
  options:[
    ...
    "Gli elettroni possono occupare qualsiasi orbita a qualsiasi distanza dal nucleo",
    "Gli elettroni non hanno mai energia definita",
    "Il nucleo emette continuamente energia per compensare la perdita degli elettroni",
    "Gli elettroni restano sempre fermi rispetto al nucleo"], correct:0 },
...
{ id:"atom-42", topic:"atomo", type:"mc",
  ...
  options:[
    ...
    "Non subisce alcun cambiamento energetico",
    "Distrugge il nucleo",
    "Emette un elettrone aggiuntivo",
...
{ id:"atom-43", topic:"atomo", type:"mc",
  ...
  options:[
    "Negava l'esistenza del nucleo atomico",
    "Prevedeva correttamente lo spettro di ogni atomo, senza eccezioni",
    "Non spiegava alcun fenomeno sperimentale osservato",
    "Era identico in tutto e per tutto al modello di Rutherford",
...
{ id:"atom-44", topic:"atomo", type:"mc",
  ...
  options:[
    "La sola forza di gravità tra i nucleoni",
    "La forza elettrostatica attrattiva tra i protoni",
    ...
    "L'assenza di carica nei protoni"], correct:2 },
...
{ id:"atom-45", topic:"atomo", type:"mc",
  ...
  options:[
    "Il numero di elettroni supera sempre quello dei protoni",
    "I neutroni diventano carichi positivamente nei nuclei grandi",
    "La forza nucleare forte aumenta indefinitamente con le dimensioni del nucleo",
    ...
    "La gravità nucleare diventa negativa"], correct:3 },
...
{ id:"tav-06", topic:"tavola", type:"mc",
  ...
  options:[
    "Perché sono tutti radioattivi",
    "Perché sono privi di elettroni",
    "Perché hanno un solo elettrone di valenza",
    "Perché hanno un numero atomico molto basso",
...
{ id:"tav-16", topic:"tavola", type:"mc",
  ...
  options:[
    ...
    "La capacità di un atomo di formare legami covalenti",
    "Il numero di elettroni di valenza di un atomo",
    "L'energia necessaria per allontanare un elettrone da un atomo",
    "La massa atomica di un elemento"], correct:0 },
...
{ id:"tav-17", topic:"tavola", type:"mc",
  ...
  options:[
    ...
    "La carica totale di un atomo neutro",
    "La massa di un atomo",
    "La dimensione del nucleo atomico"], correct:1 },
...
{ id:"tav-22", topic:"tavola", type:"mc",
  ...
  options:[
    ...
    "22,4 particelle",
    "Esattamente 1 g di sostanza",
    "6,022 g di sostanza",
    "Un numero di particelle variabile in base alla sostanza"], correct:0 },
...
{ id:"tav-23", topic:"tavola", type:"mc",
  ...
  options:[
    ...
    "1 g dell'isotopo 12 del carbonio",
    "1 mole di idrogeno"], correct:2 },
...
{ id:"tav-24", topic:"tavola", type:"mc",
  ...
  options:[
    ...
    "Una mole corrisponde sempre a 1 g, indipendentemente dal P.M.",
    "Il P.M. è sempre uguale al numero di Avogadro",
    "Il P.M. si misura in litri",
    "Il P.M. non ha alcuna relazione con la mole"], correct:0 },
...
{ id:"tav-33", topic:"tavola", type:"mc",
  ...
  options:[
    "La carica nucleare totale, senza alcuna correzione",
    ...
    "La massa atomica dell'elemento",
    "Il numero di elettroni di valenza dell'atomo"], correct:2,
...
{ id:"tav-34", topic:"tavola", type:"mc",
  ...
  options:[
    ...
    "Diminuisce",
    "Resta costante",
    "Dipende solo dal gruppo, non dal periodo",
...
{ id:"tav-36", topic:"tavola", type:"mc",
  ...
  options:[
    "Il sodio non può perdere un secondo elettrone",
    "Il primo e il secondo potenziale sono sempre identici per i metalli alcalini",
    ...
    "La seconda rimozione avviene da un orbitale più esterno",
    "Il sodio diventa un anione dopo la prima ionizzazione"], correct:2 },
...
{ id:"tav-37", topic:"tavola", type:"mc",
  ...
  options:[
    ...
    "Il solo valore dell'affinità elettronica",
    "Il solo valore dell'energia di ionizzazione",
    "Il rapporto tra energia di ionizzazione e affinità elettronica",
    "La differenza tra energia di ionizzazione e affinità elettronica"], correct:0 },
...
{ id:"tav-38", topic:"tavola", type:"mc",
  ...
  options:[
    "Questi elementi non possono mai formare anioni",
    "Sono tutti gas nobili",
    "Aggiungere un elettrone romperebbe una configurazione elettronica già particolarmente stabile",
    "Non hanno elettroni di valenza",
    "Hanno sempre la più alta affinità elettronica del periodo"], correct:2 },
...
{ id:"leg-04", topic:"legami", type:"mc",
  ...
  options:[
    "Il tipo di ibridazione degli orbitali",
    "L'energia totale della molecola",
    "La distanza tra i nuclei degli atomi legati",
...
{ id:"leg-09", topic:"legami", type:"mc",
  ...
  options:[
    ...
    "Diventa un catione",
    "Cede completamente il suo elettrone",
    "Non partecipa al legame",
    "Perde la sua identità chimica"], correct:0 },
...
{ id:"leg-13", topic:"legami", type:"mc",
  ...
  options:[
    "Sempre il doppio degli orbitali atomici di partenza",
    "Sempre pari a 2",
    "Sempre dispari",
    "Indipendente dal numero di orbitali atomici",
...
{ id:"leg-14", topic:"legami", type:"mc",
  ...
  options:[
    "Nessun elettrone di valenza",
    "Tutti gli elettroni appaiati",
    "Solo legami ionici",
    "Elettroni spaiati negli orbitali di antilegame",
    "Un legame covalente singolo"], correct:3 },
...
{ id:"leg-17", topic:"legami", type:"mc",
  ...
  options:[
    "Sono sempre gassosi",
    "Hanno basse temperature di fusione",
    "Conducono bene la corrente elettrica",
    "Non formano strutture cristalline",
...
{ id:"leg-23", topic:"legami", type:"mc",
  ...
  options:[
    ...
    "Legami ionici tra le molecole d'acqua",
    "L'assenza di legami tra le molecole",
...
{ id:"leg-26", topic:"legami", type:"mc",
  ...
  options:[
    "Molecole polari in acqua",
    "Cationi metallici in un reticolo",
    "Atomi dello stesso elemento tramite legame covalente",
    "Molecole non polari, per minimizzare il contatto con l'acqua",
    "Ioni di carica opposta"], correct:3 },
...
{ id:"geom-01", topic:"geometria", type:"mc",
  ...
  options:[
    "La temperatura di fusione del composto",
    "Esclusivamente la carica nucleare",
    "La velocità degli elettroni",
    "La disposizione degli elettroni di valenza e dei legami tra gli atomi",
    "Solo gli atomi centrali"], correct:3 },
...
{ id:"geom-06", topic:"geometria", type:"mc",
  ...
  options:[
    ...
    "Per un errore sperimentale",
    "Perché l'idrogeno è troppo piccolo",
    "Perché l'azoto è molto elettronegativo",
    "Perché la molecola è ionica"], correct:0 },
...
{ id:"geom-07", topic:"geometria", type:"mc",
  ...
  options:[
    ...
    "Perché la molecola d'acqua non rispetta la regola dell'ottetto",
    "Perché l'ossigeno ha due coppie di elettroni non condivise, che respingono maggiormente le coppie di legame",
    "Perché l'acqua è una molecola ionica",
    "Perché l'idrogeno nell'acqua ha carica negativa"], correct:2 },
...
{ id:"geom-11", topic:"geometria", type:"mc",
  ...
  options:[
    "Non ci sono legami doppi",
    "È una molecola ionica",
    "Il carbonio non è elettronegativo",
    "L'ossigeno non ha elettronegatività",
...
{ id:"geom-13", topic:"geometria", type:"mc",
  ...
  options:[
    ...
    "Non ha mai legami polarizzati",
    "Ha un solo tipo di atomo",
    "Non possiede elettroni di valenza"], correct:1 },
...
{ id:"bio-03", topic:"biomolecole", type:"mc",
  ...
  options:[
    ...
    "Sempre di natura lipidica",
    "Atomi isolati privi di legami",
    "Molecole prive di carbonio",
    "Esclusivamente ioni inorganici"], correct:0 },
...
{ id:"bio-14", topic:"biomolecole", type:"mc",
  ...
  options:[
    "Esclusivamente come anticorpi",
    "Enzimi, proteine strutturali, di trasporto, recettori e molte altre funzioni",
    "Solo come enzimi",
    "Esclusivamente strutture di deposito",
    "Solo come recettori di membrana"], correct:1 },
...
{ id:"bio-22", topic:"biomolecole", type:"mc",
  ...
  options:[
    ...
    "Il gruppo carbossilico soltanto",
    "Il gruppo solfidrilico",
    "Il gruppo fosfato e la base azotata"], correct:1 },
...
{ id:"bio-31", topic:"biomolecole", type:"mc",
  ...
  options:[
    "Unità alternate di glucosio e galattosio",
    "Solo amilosio ramificato",
    "Catene di glucosio unite da legami β1-4",
    "Amilosio (catena lineare, legami α1-4) e amilopectina (ramificata, legami α1-4 con ramificazioni α1-6)",
    "Un'unica catena non ramificata di fruttosio"], correct:3 },
...
{ id:"bio-33", topic:"biomolecole", type:"mc",
  ...
  options:[
    ...
    "α1-4, facilmente digeribili",
    "Peptidici",
    "α1-6, tipici delle ramificazioni"], correct:1,
...
{ id:"prot-03", topic:"proteine", type:"mc",
  ...
  options:[
    "Un secondo gruppo carbossilico",
    "Sempre un anello aromatico",
    "Un gruppo ossidrilico obbligatorio",
    "Un gruppo fosfato",
...
{ id:"prot-06", topic:"proteine", type:"mc",
  ...
  options:[
    "Solo acidi e basici",
    "Solo essenziali e non essenziali",
    "Solo aromatici e alifatici",
    "Polari con carica, polari senza carica e non polari",
    "Solo di tipo L e D"], correct:3 },
...
{ id:"prot-09", topic:"proteine", type:"mc",
  ...
  options:[
    ...
    "Due catene laterali R",
    "Un gruppo fosfato e un gruppo ossidrilico",
    "Due gruppi amminici",
...
{ id:"prot-12", topic:"proteine", type:"mc",
  ...
  options:[
    ...
    "Il ripiegamento tridimensionale della catena",
    "I legami a idrogeno tra foglietti β",
    "Le interazioni idrofobiche",
    "L'associazione di più subunità"], correct:0 },
...
{ id:"prot-14", topic:"proteine", type:"mc",
  ...
  options:[
    "Interazioni elettrostatiche tra catene laterali",
    "Legami a idrogeno tra i gruppi C=O e N–H dello scheletro peptidico",
    "Legami covalenti tra amminoacidi non adiacenti",
    "Forze di van der Waals esclusivamente",
...
{ id:"prot-19", topic:"proteine", type:"mc",
  ...
  options:[
    "Un tipo di modificazione post-traduzionale",
    "La sola sequenza amminoacidica",
    "L'associazione di più catene polipeptidiche",
    "La composizione percentuale in amminoacidi",
...
{ id:"prot-38", topic:"proteine", type:"mc",
  ...
  options:[
    ...
    "Sono presenti solo negli organismi vegetali",
    "Non partecipano mai alla struttura delle proteine",
    "Vengono sintetizzati a partire da altri intermedi metabolici",
    "Non possiedono un centro chirale"], correct:0,
...
{ id:"prot-39", topic:"proteine", type:"mc",
  ...
  options:[
    "Non presenta un gruppo carbossilico",
    "Possiede sia un gruppo acido (-COOH) sia un gruppo basico (-NH₂) e può comportarsi come acido o come base a seconda del pH",
    "Non ha mai carica netta",
    "È sempre carico positivamente",
    "Non può dissociarsi in acqua"], correct:1 },
...
{ id:"prot-40", topic:"proteine", type:"mc",
  ...
  options:[
    ...
    "Forma neutra priva di cariche parziali",
    "Forma radicalica",
    "Forma completamente cationica, a carica netta +1",
    "Forma completamente anionica, a carica netta -1"], correct:0 },

{ id:"prot-41", topic:"proteine", type:"mc",
  q:"Il 'dogma di Anfisen', formulato in seguito a esperimenti sulla ribonucleasi, afferma che:",
  options:[
    "Il ripiegamento di una proteina richiede sempre un manuale di istruzioni esterno",
    ...
    "Ogni proteina ha una struttura primaria diversa da quella codificata dal gene",
    "Le proteine denaturate non possono mai recuperare la loro struttura originale",
    "Il ripiegamento proteico dipende esclusivamente dalla temperatura"], correct:1 },
...
{ id:"prot-42", topic:"proteine", type:"mc",
  ...
  options:[
    ...
    "Tagliando la catena polipeptidica in frammenti più piccoli",
    "Degradando la proteina non ripiegata correttamente",
    "Isolando la proteina in un compartimento cavo chiuso da un coperchio",
...
{ id:"prot-43", topic:"proteine", type:"mc",
  ...
  options:[
    "Marcandola con ubiquitina per la degradazione",
    "Tagliando la proteina in pezzi più piccoli e riassemblandola casualmente",
    ...
    "Legandosi solo ai tratti idrofilici della proteina",
    "Trasportandola direttamente al nucleo"], correct:2 },
...
{ id:"prot-44", topic:"proteine", type:"mc",
  ...
  options:[
    ...
    "Aumentare la stabilità termica della proteina",
    "Aumentare la sua massa molecolare in modo permanente",
    "Impedirne la degradazione da parte del proteasoma",
    "Facilitarne il trasporto nel nucleo"], correct:0 },
...
{ id:"prot-45", topic:"proteine", type:"mc",
  ...
  options:[
    ...
    "Solo durante la trascrizione del gene",
    "Solo nei mitocondri",
    "Solo nel citoplasma, ambiente riducente",
    "In qualunque compartimento cellulare indifferentemente"], correct:0 },
...
{ id:"prot-49", topic:"proteine", type:"mc",
  ...
  options:[
    "Proteine primarie e proteine secondarie",
    "Proteine acide e proteine basiche soltanto",
    "Proteine essenziali e non essenziali",
    "Solo proteine di membrana e proteine citosoliche",
...
{ id:"enz-02", topic:"enzimi", type:"mc",
  ...
  options:[
    "Vengono consumati durante la reazione catalizzata",
    "Funzionano solo ad altissime concentrazioni",
    "Sono privi di specificità",
    "Modificano l'equilibrio della reazione chimica",
...
{ id:"enz-05", topic:"enzimi", type:"mc",
  ...
  options:[
    ...
    "La velocità minima possibile della reazione",
    "La concentrazione di substrato a metà della velocità massima",
    "La costante di equilibrio della reazione",
    "Il numero di siti attivi dell'enzima"], correct:0 },
...
{ id:"enz-07", topic:"enzimi", type:"mc",
  ...
  options:[
    "Mai",
    "Molto inefficientemente",
    "Solo a temperature elevate",
    "In modo indipendente dalla concentrazione",
    "Molto efficientemente (alta affinità)"], correct:4 },

{ id:"enz-08", topic:"enzimi", type:"mc",
  q:"Il catabolismo è un processo:",
  options:[
    "Indipendente dagli enzimi",
    "Che richiede sempre ATP come substrato iniziale",
    "Endoenergetico che costruisce molecole complesse",
    "Che avviene solo nel nucleo",
...
{ id:"enz-09", topic:"enzimi", type:"mc",
  ...
  options:[
    ...
    "Che libera sempre $CO_2$ e $H_2O$",
    "Tipico solo delle reazioni cataboliche",
    "Esoenergetico di degradazione"], correct:0 },
...
{ id:"enz-10", topic:"enzimi", type:"mc",
  ...
  options:[
    ...
    "Solo calore disperso",
    "Esclusivamente altro glucosio",
    "Acqua pura"], correct:1 },
...
{ id:"enz-23", topic:"enzimi", type:"mc",
  ...
  options:[
    "Immediatamente degradato dal proteasoma",
    "Trasformato in un inibitore competitivo",
    "Privo di struttura primaria",
    "Più attivo del normale",
...
{ id:"enz-25", topic:"enzimi", type:"mc",
  ...
  options:[
    "L'enzima perde la sua struttura terziaria",
    "Non avviene alcun cambiamento conformazionale",
    "Il substrato deve avere già una forma identica al sito attivo",
    "Il legame avviene solo in assenza di cofattori",
...
{ id:"enz-26", topic:"enzimi", type:"mc",
  ...
  options:[
    ...
    "Agisce solo sugli enzimi extracellulari",
    "Cambia la sequenza amminoacidica dell'enzima",
    "Modifica solo la temperatura della soluzione",
    "Non ha alcun effetto sull'enzima"], correct:0 },

{ id:"enz-27", topic:"enzimi", type:"mc",
  q:"Aumentando la temperatura oltre l'optimum di un enzima, l'attività enzimatica:",
  options:[
    "Aumenta solo se l'enzima ha cofattori metallici",
    "Continua ad aumentare indefinitamente",
    ...
    "Diventa indipendente dalla concentrazione di substrato"], correct:2 },
...
{ id:"enz-28", topic:"enzimi", type:"mc",
  ...
  options:[
    "Diventa negativa",
    "Diminuisce sempre",
    "Continua ad aumentare linearmente senza limite",
    "Raggiunge un massimo (Vmax) perché tutti i siti attivi disponibili sono occupati contemporaneamente",
    "Si azzera immediatamente"], correct:3 },

{ id:"enz-29", topic:"enzimi", type:"mc",
  q:"Nell'inibizione competitiva, l'inibitore:",
  options:[
    "Aumenta sempre la Vmax dell'enzima",
    "Si lega sempre in un sito diverso dal sito attivo",
    "Distrugge permanentemente il sito attivo",
    "Non può mai essere spiazzato aumentando la concentrazione di substrato",
...
{ id:"enz-30", topic:"enzimi", type:"mc",
  ...
  options:[
    "Viene sempre spiazzato aumentando la concentrazione di substrato",
    "Compete direttamente con il substrato per lo stesso sito",
    "Agisce solo sui cofattori metallici",
    ...
    "Non ha alcun effetto sulla struttura dell'enzima"], correct:3 },
...
{ id:"enz-31", topic:"enzimi", type:"mc",
  ...
  options:[
    "Un coenzima non correlato",
    "La temperatura corporea",
    "Un gene regolatore direttamente",
    "Il primo substrato della via",
...
{ id:"lip-01", topic:"lipidi", type:"mc",
  ...
  options:[
    "Anelli aromatici complessi",
    "Catene lineari di carbonio con un gruppo carbossilico terminale",
    "Amminoacidi legati covalentemente",
    "Solo atomi di azoto e fosforo",
    "Basi azotate legate a zuccheri"], correct:1 },
...
{ id:"lip-04", topic:"lipidi", type:"mc",
  ...
  options:[
    "È legato al glicerolo",
    "Contiene un gruppo fosfato",
    "Non contiene atomi di idrogeno",
    "È privo del gruppo carbossilico",
...
{ id:"lip-21", topic:"lipidi", type:"mc",
  ...
  options:[
    ...
    "La posizione del gruppo carbossilico",
    "Il numero di atomi di ossigeno",
    "Il numero totale di doppi legami presenti",
    "Il numero di atomi di carbonio della catena"], correct:0 },
...
{ id:"lip-22", topic:"lipidi", type:"mc",
  ...
  options:[
    ...
    "Non hanno alcuna funzione biologica nota",
    "Sono sempre saturi",
    "Vengono sintetizzati esclusivamente dal fegato",
    "Sono gli unici acidi grassi presenti nelle membrane cellulari"], correct:0 },

{ id:"lip-23", topic:"lipidi", type:"mc",
  q:"In base alla funzione svolta nell'organismo, i lipidi si distinguono in:",
  options:[
    "Solo lipidi saturi e insaturi",
    ...
    "Lipidi polari e lipidi acidi soltanto",
    "Lipidi essenziali e lipidi tossici",
    "Solo lipidi animali e vegetali"], correct:1 },
...
{ id:"lip-27", topic:"lipidi", type:"mc",
  ...
  options:[
    ...
    "Colesterolo endogeno verso il fegato",
    "Solo fosfolipidi",
    "Solo acidi grassi liberi",
    "Trigliceridi endogeni sintetizzati dal fegato"], correct:0,
...
{ id:"lip-29", topic:"lipidi", type:"mc",
  ...
  options:[
    "Esclusivamente ai reni",
    "Solo dopo i pasti",
    "Solo dall'intestino al fegato",
    "Dal fegato ai tessuti, ed è responsabile del danno arterioso se in eccesso",
    "Dai tessuti al fegato, per essere eliminato"], correct:3 },
...
{ id:"lip-30", topic:"lipidi", type:"mc",
  ...
  options:[
    "Danneggiare le pareti arteriose",
    "Sintetizzare acidi grassi nel fegato",
    "Trasportare i trigliceridi alimentari ai tessuti subito dopo i pasti",
    "Trasportare glucosio nei muscoli",
...
{ id:"lip-33", topic:"lipidi", type:"mc",
  ...
  options:[
    "Degradare il glicogeno",
    "Formare i ponti disolfuro delle lipoproteine",
    "Regolare l'ingresso degli acidi grassi nel mitocondrio",
    "Sintetizzare acidi grassi de novo",
    "Trasportare il colesterolo nel sangue"], correct:2 },
...
{ id:"lip-34", topic:"lipidi", type:"mc",
  ...
  options:[
    ...
    "Ai ribosomi mitocondriali",
    "All'acido piruvico",
    "Alla carnitina, per essere riciclati",
    "Direttamente al glucosio"], correct:0 },
...
{ id:"membr-02", topic:"membrane", type:"mc",
  ...
  options:[
    "Esclusivamente proteine, senza lipidi",
    "Un reticolo cristallino di ioni",
    "Un singolo strato proteico rigido",
    "Un doppio strato lipidico fluido in cui le proteine sono incastrate come tessere di un mosaico",
    "Fibre di collagene intrecciate"], correct:3 },
...
{ id:"membr-11", topic:"membrane", type:"mc",
  ...
  options:[
    ...
    "Sempre il 100% proteine",
    "Il rapporto è fisso e identico in tutte le membrane",
    "Le membrane non contengono mai proteine",
    "Sempre il 100% lipidi"], correct:0 },
...
{ id:"membr-12", topic:"membrane", type:"mc",
  ...
  options:[
    ...
    "Nessuna correlazione con la funzione",
    "Assenza di funzione",
    "Solo membrane vegetali",
    "Funzione di isolamento elettrico"], correct:0,
...
{ id:"membr-14", topic:"membrane", type:"mc",
  ...
  options:[
    ...
    "Un enzima che degrada le proteine della matrice extracellulare",
    "Un polisaccaride presente nella matrice extracellulare",
    "Una proteina integrale di membrana priva di funzione adesiva"], correct:1,
  explain:"Domanda dalla prova ufficiale del semestre filtro 2025 (secondo appello)." },
...
{ id:"membr-26", topic:"membrane", type:"mc",
  ...
  options:[
    "Caratteristico solo delle membrane procariotiche",
    "Frequente e spontaneo, più veloce della diffusione laterale",
    "Raro, perché richiede il passaggio della testa polare attraverso l'interno idrofobico; è catalizzato dalle flippasi",
    "Impossibile in ogni condizione",
    "Indipendente dall'energia e molto rapido"], correct:2 },
...
{ id:"membr-27", topic:"membrane", type:"mc",
  ...
  options:[
    ...
    "Che il DNA si trasferisce tra cellule di specie diverse",
    "Che le cellule di specie diverse non possono fondersi",
    "Che i lipidi di membrana non si muovono mai",
    "Che le membrane sono completamente rigide e immobili"], correct:0,
...
{ id:"membr-28", topic:"membrane", type:"mc",
  ...
  options:[
    "Solo la presenza di ioni calcio",
    "Esclusivamente la pressione osmotica",
    "Solo la concentrazione di glucosio extracellulare",
    ...
    "Solo il pH extracellulare"], correct:3 },
...
{ id:"membr-30", topic:"membrane", type:"mc",
  ...
  options:[
    "Esclusivamente dalla pressione osmotica",
    ...
    "Solo dalla temperatura ambientale",
    "La sola presenza di colesterolo",
    "Il pH del citosol"], correct:1 },
...
{ id:"membr-31", topic:"membrane", type:"mc",
  ...
  options:[
    "Segnale di proliferazione cellulare",
    "Attivatore della sintesi proteica ribosomiale",
    "Barriera che impedisce la fagocitosi",
    "'Eat-me signal' che favorisce il riconoscimento e la fagocitosi della cellula apoptotica da parte dei macrofagi",
    "Segnale che induce la mitosi"], correct:3,
...
{ id:"membr-32", topic:"membrane", type:"mc",
  ...
  options:[
    "Esclusivamente molecole di DNA",
    "Solo colesterolo libero",
    ...
    "Ioni calcio legati direttamente ai fosfolipidi"], correct:2 },
...
{ id:"membr-34", topic:"membrane", type:"mc",
  ...
  options:[
    "La sequenza del DNA mitocondriale",
    "Ormoni steroidei circolanti nel plasma",
    "Proteine del citoscheletro degli eritrociti",
    "Il numero di mitocondri presenti nei globuli rossi",
...
{ id:"membr-35", topic:"membrane", type:"mc",
  ...
  options:[
    ...
    "Piccole molecole polari cariche",
    "Grosse molecole polari come il glucosio",
    "Ioni come $Na^+$ e $K^+$"], correct:1 },

{ id:"membr-36", topic:"membrane", type:"mc",
  q:"Il trasporto attivo di membrana si distingue da quello passivo perché:",
  options:[
    "Riguarda esclusivamente il trasporto dei gas respiratori",
    "Non richiede mai una proteina di membrana",
    "Avviene sempre più lentamente",
    "Avviene contro gradiente (di concentrazione o elettrochimico) e richiede consumo di energia",
    "Non può mai essere mediato da una pompa"], correct:3 },

{ id:"membr-37", topic:"membrane", type:"mc",
  q:"La diffusione facilitata, a differenza della diffusione semplice:",
  options:[
    "Non presenta mai un fenomeno di saturazione",
    ...
    "Avviene sempre contro gradiente di concentrazione",
    "Riguarda solo il trasporto di ioni metallici",
    "Richiede il consumo diretto di ATP"], correct:1 },

{ id:"membr-38", topic:"membrane", type:"mc",
  q:"I trasportatori (carrier) di membrana muovono il soluto attraverso:",
  options:[
    "La formazione di una vescicola di endocitosi",
    ...
    "Un poro sempre aperto, privo di regolazione",
    "La rottura temporanea del doppio strato lipidico",
    "Un legame covalente permanente con il soluto trasportato"], correct:1 },
...
{ id:"membr-40", topic:"membrane", type:"mc",
  ...
  options:[
    "Restano sempre in uno stato aperto",
    "Trasportano solo acqua per osmosi",
    "Funzionano esclusivamente per ossidoriduzione",
    "Oscillano tra uno stato aperto e uno chiuso, regolati da meccanismi diversi (voltaggio, ligando, stimoli meccanici)",
    "Restano sempre in uno stato chiuso"], correct:3 },
...
{ id:"membr-41", topic:"membrane", type:"mc",
  ...
  options:[
    ...
    "Il pH del citosol esclusivamente",
    "La concentrazione di glucosio extracellulare",
    "Il legame con un ormone steroideo"], correct:1,
...
{ id:"membr-43", topic:"membrane", type:"mc",
  ...
  options:[
    ...
    "La glicolisi anaerobica nel citosol",
    "La fotosintesi nei cloroplasti",
    "La duplicazione del DNA nucleare",
...
{ id:"membr-44", topic:"membrane", type:"mc",
  ...
  options:[
    "Trasportano esclusivamente molecole d'acqua",
    "Sono presenti solo nei batteri, mai negli eucarioti",
    "Legano e idrolizzano ATP per pompare piccole molecole (amminoacidi, peptidi, steroli) attraverso la membrana",
    "Non legano mai l'ATP",
    "Sono canali ionici regolati da voltaggio"], correct:2 },

{ id:"membr-45", topic:"membrane", type:"mc",
  q:"Una cellula immersa in una soluzione ipotonica rispetto al suo citoplasma:",
  options:[
    "Perde immediatamente ioni $Na^+$",
    "Perde acqua netta e si raggrinzisce",
    "Guadagna acqua netta per osmosi e tende a rigonfiarsi",
    "Non subisce alcun movimento netto di acqua",
    "Va incontro a mitosi immediata"], correct:2 },
...
{ id:"proc-05", topic:"procarioti", type:"mc",
  ...
  options:[
    "Dividersi soltanto",
    "Accrescersi soltanto",
    "Sintetizzare proteine soltanto",
    "Vivere e riprodursi autonomamente come organismo indipendente",
    "Contenere DNA soltanto"], correct:3 },
...
{ id:"proc-07", topic:"procarioti", type:"mc",
  ...
  options:[
    ...
    "La presenza della membrana plasmatica",
    "La presenza di DNA"], correct:2 },
...
{ id:"proc-10", topic:"procarioti", type:"mc",
  ...
  options:[
    "L'assenza di pili e flagelli nei Gram-negativi e la presenza nei Gram positivi",
    "Nessuna delle affermazioni enunciate è corretta",
    ...
    "La disposizione di flagelli e pili",
...
{ id:"proc-12", topic:"procarioti", type:"mc",
  ...
  options:[
    ...
    "Una parete di chitina",
    "Uno strato di peptidoglicano più spesso",
    "L'assenza di membrana plasmatica"], correct:1 },
...
{ id:"proc-21", topic:"procarioti", type:"mc",
  ...
  options:[
    "Virus integrati nel genoma dell'ospite",
    "Vescicole del reticolo endoplasmatico",
    "Batteri endosimbionti inglobati da una cellula ospite ancestrale",
    "Frammenti del nucleo",
    "Invaginazioni della membrana plasmatica"], correct:2 },
...
{ id:"proc-32", topic:"procarioti", type:"mc",
  ...
  options:[
    "Sintetizzare proteine di membrana",
    "Digerire macromolecole extracellulari",
    "Aumentare la superficie disponibile per la respirazione e la replicazione del DNA",
    "Produrre energia luminosa",
    "Racchiudere il materiale genetico in un compartimento separato"], correct:2 },

{ id:"proc-33", topic:"procarioti", type:"mc",
  q:"I plasmidi sono:",
  options:[
    "RNA messaggeri batterici",
    "Proteine strutturali della parete cellulare",
    "Organelli membranosi tipici degli eucarioti",
    ...
    "Il cromosoma principale del batterio"], correct:3 },
...
{ id:"proc-34", topic:"procarioti", type:"mc",
  ...
  options:[
    "Da più origini simultanee sempre",
    "Senza l'intervento di alcuna DNA polimerasi",
    "Solo dopo la formazione del setto",
    "In modo unidirezionale soltanto",
...
{ id:"proc-35", topic:"procarioti", type:"mc",
  ...
  options:[
    "Sintesi della parete cellulare soltanto",
    "Colorazione di Gram",
    "Formazione dell'anello contrattile a livello del futuro punto di divisione cellulare",
    "Formazione dei pili sessuali",
    "Replicazione del DNA plasmidico"], correct:2 },

{ id:"proc-36", topic:"procarioti", type:"mc",
  q:"Nella fase finale della scissione binaria, detta citodieresi:",
  options:[
    "Avviene la coniugazione con un'altra cellula",
    "Si formano solo mesosomi",
    "Il DNA viene degradato",
    ...
    "La cellula si arresta definitivamente senza dividersi"], correct:3 },
...
{ id:"vir-08", topic:"virus", type:"mc",
  ...
  options:[
    ...
    "Alla presenza di parete cellulare",
    "Alla presenza di flagelli",
    "Alla loro dimensione soltanto",
    "Alla loro capacità fotosintetica"], correct:0 },
...
{ id:"vir-10", topic:"virus", type:"mc",
  ...
  options:[
    ...
    "Viene immediatamente replicato e la cellula viene lisata",
    "Non entra mai nella cellula ospite",
    "Viene degradato dagli enzimi batterici",
    "Esce subito dalla cellula"], correct:0 },
...
{ id:"vir-12", topic:"virus", type:"mc",
  ...
  options:[
    "Attacco, replicazione, rilascio, penetrazione",
    "Biosintesi, attacco, assemblaggio, penetrazione",
    "Attacco, penetrazione, liberazione dell'acido nucleico, replicazione e biosintesi, assemblaggio, rilascio",
    "Rilascio, attacco, penetrazione, replicazione",
    "Penetrazione, rilascio, attacco, biosintesi"], correct:2 },
...
{ id:"vir-15", topic:"virus", type:"mc",
  ...
  options:[
    "La duplicazione del capside",
    "La sintesi proteica",
    "La sintesi di DNA a partire da uno stampo di RNA",
    "La degradazione dell'RNA virale",
...
{ id:"vir-17", topic:"virus", type:"mc",
  ...
  options:[
    ...
    "Il citoscheletro",
    "I ribosomi",
    "I lipidi di membrana in modo aspecifico",
...
{ id:"vir-26", topic:"virus", type:"mc",
  ...
  options:[
    "Il solo tipo di cellula ospite infettata",
    "La presenza o assenza di envelope soltanto",
    "La sola forma del capside",
    "Quanti e quali passaggi servono per arrivare dal genoma virale a un mRNA funzionante",
    "Le sole dimensioni del virione"], correct:3,
...
{ id:"vir-31", topic:"virus", type:"mc",
  ...
  options:[
    "Diffusione semplice attraverso la parete cellulare",
    "Endocitosi (processo pH-dipendente, mediata da una vescicola rivestita di clatrina)",
    "Osmosi diretta",
    "Fagocitosi da parte del virus stesso",
    "Trasporto attivo ATP-dipendente del virus"], correct:1 },
...
{ id:"vir-36", topic:"virus", type:"mc",
  ...
  options:[
    "Non hanno alcuna interazione con la cellula ospite",
    "Non sono mai in grado di integrarsi nel genoma ospite",
    "Agiscono esclusivamente per via extracellulare",
    ...
    "Causano solo infezioni acute autolimitanti"], correct:3 },
...
{ id:"vir-37", topic:"virus", type:"mc",
  ...
  options:[
    "Solo tramite trascrittasi inversa",
    ...
    "Tramite un oncogene virale dominante diretto",
    "Solo per contatto diretto con il DNA ospite",
    "Non essendo in alcun modo associati a neoplasie"], correct:1 },
...
{ id:"vir-38", topic:"virus", type:"mc",
  ...
  options:[
    ...
    "Geni oppressori tumorali mutati soltanto nell'ospite",
    "Frammenti di rRNA",
    "Geni batterici",
    "Sequenze non codificanti del genoma virale"], correct:0 },
...
{ id:"vir-40", topic:"virus", type:"mc",
  ...
  options:[
    ...
    "La formazione dei pili batterici",
    "Il taglio del capside",
    "La sintesi del solo RNA ribosomiale"], correct:1 },
...
{ id:"vir-41", topic:"virus", type:"mc",
  ...
  options:[
    "Integrare il profago nel cromosoma batterico",
    "Sintetizzare la parete cellulare batterica",
    "Lisare immediatamente la cellula",
    "Assemblare direttamente il capside maturo",
...
{ id:"vir-42", topic:"virus", type:"mc",
  ...
  options:[
    "Vengono espresse solo durante la lisi",
    "Attivano immediatamente il ciclo litico",
    "Distruggono il cromosoma batterico",
    "Non hanno alcuna funzione regolatoria",
...
{ id:"acnu-03", topic:"acidinucleici", type:"mc",
  ...
  options:[
    ...
    "Più bassa, perché le coppie G-C sono meno stabili",
    "Indipendente dalla composizione in basi",
    "Identica in ogni caso"], correct:0 },

{ id:"acnu-04", topic:"acidinucleici", type:"mc",
  q:"La denaturazione del DNA consiste in:",
  options:[
    "La sintesi di un nuovo filamento di DNA complementare",
    "La separazione delle due eliche per rottura dei legami idrogeno tra le basi appaiate",
    "La formazione di nuovi legami covalenti tra le due eliche",
    "La metilazione delle citosine del DNA",
    "La rottura dei legami fosfodiestere dello scheletro zucchero-fosfato"], correct:1 },
...
{ id:"acnu-06", topic:"acidinucleici", type:"mc",
  ...
  options:[
    ...
    "Formare l'ottamero centrale del nucleosoma",
    "Digerire il DNA danneggiato",
    "Trasportare il DNA fuori dal nucleo",
    "Catalizzare la duplicazione del DNA"], correct:0 },
...
{ id:"acnu-07", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Eterocromatina → eucromatina → DNA nudo, senza altri passaggi",
    ...
    "Nucleosoma → DNA nudo → cromosoma metafasico → fibra da 30 nm",
    "Cromosoma metafasico → fibra da 30 nm → DNA nudo → nucleosoma",
    "Il DNA passa direttamente da nudo a cromosoma metafasico"], correct:1 },

{ id:"acnu-08", topic:"acidinucleici", type:"mc",
  q:"L'eucromatina, rispetto all'eterocromatina, è:",
  options:[
    "Più condensata e sempre trascrizionalmente inattiva",
    "Meno condensata (lassa) e generalmente trascrizionalmente attiva",
    "Identica per grado di condensazione",
    "Priva di istoni associati",
    "Presente solo nelle cellule procariotiche"], correct:1 },

{ id:"acnu-09", topic:"acidinucleici", type:"mc",
  q:"L'eterocromatina facoltativa, a differenza di quella costitutiva:",
  options:[
    "È composta esclusivamente da RNA, senza DNA",
    "È inattivata solo in specifiche fasi dello sviluppo o in determinati tipi cellulari, potendo tornare attiva",
    "Non è mai presente nel genoma eucariotico",
    "Si trova solo nel DNA mitocondriale",
    "Resta sempre condensata e non trascritta in tutte le cellule"], correct:1 },
...
{ id:"acnu-12", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "È identica in tutti gli organismi eucarioti",
    "È sempre direttamente proporzionale alla sua complessità biologica",
    "Dipende esclusivamente dal numero di cromosomi",
    ...
    "Determina univocamente il numero di specie di un taxon"], correct:3 },
...
{ id:"acnu-19", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Solo una base azotata e un fosfato",
    "Uno zucchero pentoso, un gruppo fosfato e una base azotata",
    "Uno zucchero esoso e due basi azotate",
    "Un amminoacido, un fosfato e uno zucchero",
    "Due zuccheri pentosi e una base azotata"], correct:1 },
...
{ id:"acnu-20", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Un doppio legame aggiuntivo",
    "Un gruppo -OH, assente nel desossiribosio (che ha solo -H)",
    "Un atomo di azoto in più",
    "Un gruppo amminico",
    "Un gruppo fosfato aggiuntivo"], correct:1 },
...
{ id:"acnu-24", topic:"acidinucleici", type:"mc",
  ...
  options:[
    ...
    "Peptidico",
    "Estere tra due zuccheri",
    "Fosfodiesterico",
    "Idrogeno covalente"], correct:0 },
...
{ id:"acnu-27", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "In entrambe le direzioni indifferentemente",
    "3' → 5'",
    "Solo in direzione 3' → 3'",
    "5' → 3', aggiungendo nuovi nucleotidi all'estremità 3'-OH libera",
    "Dal centro verso le due estremità"], correct:3 },
...
{ id:"acnu-29", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Il principio trasformante era certamente una proteina",
    "I batteri S da soli non erano mai virulenti",
    "I batteri R non potevano mai essere trasformati",
    ...
    "Il topo sopravviveva sempre a qualunque combinazione di batteri"], correct:3,
...
{ id:"acnu-31", topic:"acidinucleici", type:"mc",
  ...
  options:[
    ...
    "La composizione in basi è identica in tutti gli organismi",
    "Tutte le basi sono sempre presenti in eguale quantità tra loro",
    "La quantità di purine è sempre doppia rispetto a quella delle pirimidine",
    "Il DNA contiene sempre più uracile che timina"], correct:0 },
...
{ id:"acnu-32", topic:"acidinucleici", type:"mc",
  ...
  options:[
    ...
    "I batteriofagi non contengono acidi nucleici",
    "Il fosforo non è mai presente negli acidi nucleici",
    "Il materiale genetico è costituito da proteine",
    "DNA e proteine contribuiscono in egual misura al materiale genetico"], correct:0 },
...
{ id:"acnu-36", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Avviene sempre la denaturazione del DNA",
    "Le proteine regolatrici (fattori di trascrizione, enzimi) leggono la sequenza di basi senza dover aprire l'elica",
    "Si legano esclusivamente gli istoni",
    "Si formano i nucleosomi",
    "Ha luogo la sintesi dei ribosomi"], correct:1 },
...
{ id:"acnu-37", topic:"acidinucleici", type:"mc",
  ...
  options:[
    ...
    "Sia i legami idrogeno sia quelli fosfodiesterici in modo permanente",
    "Nessun tipo di legame, ma solo interazioni idrofobiche",
    "Solo i legami tra zucchero e base",
    "I legami fosfodiesterici covalenti dello scheletro"], correct:0 },
...
{ id:"acnu-38", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Indipendente dalla lunghezza della molecola",
    "Più bassa",
    "Uguale, perché la Tm non dipende dalla composizione in basi",
    "Pari a 0 °C in ogni caso",
...
{ id:"acnu-39", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Una perdita totale di assorbimento UV",
    "Un cambiamento di colore visibile a occhio nudo",
    "Una diminuzione dell'assorbanza a 260 nm",
    ...
    "Un aumento della fluorescenza visibile"], correct:3 },
...
{ id:"acnu-41", topic:"acidinucleici", type:"mc",
  ...
  options:[
    ...
    "Impedire la trascrizione dei geni",
    "Formare più facilmente i nucleosomi",
    "Aumentare la velocità di replicazione",
    "Stabilizzare i legami idrogeno con la guanina"], correct:0 },
...
{ id:"acnu-42", topic:"acidinucleici", type:"mc",
  ...
  options:[
    ...
    "Sempre a doppio filamento rigido",
    "Privo di gruppo fosfato",
    "Incapace di legare proteine",
    "Privo di basi azotate"], correct:0 },
...
{ id:"acnu-43", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Solo un anticodone in 5'",
    "Una struttura a trifoglio permanente",
    "Un cappuccio (cap) in 5' e una coda poli-A in 3', che ne aumentano la stabilità e ne regolano l'espressione",
    "Una sequenza identica in ogni cellula, indipendentemente dal gene trascritto",
    "Nessuna modificazione alle estremità"], correct:2 },
...
{ id:"acnu-44", topic:"acidinucleici", type:"mc",
  ...
  options:[
    ...
    "Anello privo di struttura secondaria",
    "Foglietto β continuo",
    "Struttura globulare compatta priva di basi appaiate",
    "Doppia elica rigida"], correct:0 },
...
{ id:"acnu-48", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Saldare i frammenti di Okazaki",
    "Legarsi ai filamenti singoli appena separati, impedendo che si riappaino prematuramente",
    "Correggere gli errori di appaiamento delle basi",
    "Tagliare e risaldare il DNA per rilasciare la tensione torsionale",
    "Sintetizzare il primer di RNA"], correct:1 },
...
{ id:"acnu-60", topic:"acidinucleici", type:"mc",
  ...
  options:[
    ...
    "Sempre presenti in una sola copia per cellula",
    "Costituiti da RNA anziché DNA",
    "Circolari come quelli batterici",
    "Privi di DNA a doppio filamento"], correct:0 },
...
{ id:"acnu-62", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "I telomeri impediscono completamente la replicazione del DNA",
    "Il cromosoma si allunga a ogni ciclo di replicazione",
    "La DNA ligasi non esiste negli eucarioti",
    ...
    "La DNA polimerasi non può mai sintetizzare DNA nei cromosomi lineari"], correct:3,
...
{ id:"acnu-63", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Si allungano indefinitamente senza mai accorciarsi",
    ...
    "Codificano proteine essenziali per la sopravvivenza cellulare",
    "Sono identici alle sequenze centromeriche",
    "Impediscono completamente qualsiasi accorciamento del cromosoma"], correct:1 },
...
{ id:"acnu-64", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Sintetizza DNA senza mai usare uno stampo",
    "Agisce solo sul filamento veloce (leading strand)",
    "Porta con sé un proprio stampo a RNA interno, che usa per sintetizzare nuovo DNA telomerico",
    "Non richiede alcuna componente RNA",
    "È attiva in tutte le cellule somatiche adulte allo stesso livello"], correct:2,
...
{ id:"acnu-67", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Costituite prevalentemente da acidi grassi",
    "Proteine cariche negativamente come il DNA",
    "Prive di carica elettrica netta",
    "Proteine fortemente basiche, ricche di residui di lisina e arginina, carichi positivamente a pH fisiologico",
    "Solubili solo in ambiente fortemente acido"], correct:3 },
...
{ id:"acnu-69", topic:"acidinucleici", type:"mc",
  ...
  options:[
    ...
    "Solo il modello a foglietto β",
    "Il modello a solenoide (elica continua) e il modello a zig-zag (due file di nucleosomi intrecciate)",
    "Solo il modello a doppia elica",
    "Il modello del mare di elettroni"], correct:2 },
...
{ id:"acnu-70", topic:"acidinucleici", type:"mc",
  ...
  options:[
    ...
    "Può alternarsi tra stato condensato e decondensato a seconda del tipo cellulare",
    "È presente solo nelle cellule tumorali",
    "Si trova esclusivamente nel citoplasma",
    "Contiene la maggior parte dei geni codificanti espressi"], correct:0 },
...
{ id:"acnu-71", topic:"acidinucleici", type:"mc",
  ...
  options:[
    ...
    "Il centromero di tutti i cromosomi",
    "Il nucleolo",
    "Il DNA mitocondriale"], correct:1 },
...
{ id:"acnu-72", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Aggiungono gruppi acetile agli istoni",
    "Non richiedono alcun apporto energetico",
    "Degradano il DNA in frammenti più piccoli",
    ...
    "Agiscono esclusivamente sul DNA mitocondriale"], correct:3 },
...
{ id:"acnu-73", topic:"acidinucleici", type:"mc",
  ...
  options:[
    "Aggiunge una carica negativa aggiuntiva al DNA",
    "Non ha alcun effetto sulla struttura della cromatina",
    "Taglia il DNA in frammenti più accessibili",
    "Rimuove fisicamente gli istoni dal DNA",
...
{ id:"org-05", topic:"organelli", type:"mc",
  ...
  options:[
    "Digestione di macromolecole a pH acido",
    "Sintesi di lipidi e steroidi",
    "Stoccaggio esclusivo del $Ca^{2+}$",
    "Detossificazione da farmaci e xenobiotici",
...
{ id:"org-06", topic:"organelli", type:"mc",
  ...
  options:[
    "L'assemblaggio delle subunità ribosomali",
    "La sintesi e N-glicosilazione di proteine secrete",
    "La sintesi di lipidi/steroidi, la detossificazione (citocromo P450) e lo stoccaggio del $Ca^{2+}$",
    "La fagocitosi di particelle estranee",
    "La duplicazione del DNA mitocondriale"], correct:2 },

{ id:"org-07", topic:"organelli", type:"mc",
  q:"I ribosomi liberi nel citoplasma delle cellule eucariotiche sono di tipo:",
  options:[
    "70S, come quelli procariotici",
    "Presenti solo nel nucleo",
    "80S, costituiti da una subunità maggiore 60S e una minore 40S",
    "Privi di componente RNA",
    "Costituiti da un'unica subunità"], correct:2 },
...
{ id:"org-08", topic:"organelli", type:"mc",
  ...
  options:[
    ...
    "Non contengono alcuna proteina propria",
    "Sono completamente indipendenti dal resto della cellula",
    "Derivano direttamente dall'apparato del Golgi",
    "Non sono mai in grado di dividersi"], correct:0 },

{ id:"org-09", topic:"organelli", type:"mc",
  q:"Le creste mitocondriali sono ripiegamenti:",
  options:[
    "Della membrana esterna del mitocondrio",
...
{ id:"org-10", topic:"organelli", type:"mc",
  ...
  options:[
    "Trans, da cui il materiale viene poi rispedito al RE",
    "Non esiste una polarità funzionale nel Golgi",
    "Basale",
...
{ id:"org-13", topic:"organelli", type:"mc",
  ...
  options:[
    "Solo filamenti di miosina",
    "Solo filamenti di cheratina",
    "Microfilamenti di actina, microtubuli e filamenti intermedi",
    "Fibre di collagene",
    "Solo microtubuli"], correct:2 },
...
{ id:"org-14", topic:"organelli", type:"mc",
  ...
  options:[
    ...
    "Nessuna delle due si muove lungo i microtubuli",
    "'+' entrambe",
    "'−' la chinesina e '+' la dineina",
    "'−' entrambe"], correct:0 },
...
{ id:"sol-04", topic:"soluzioni", type:"mc",
  ...
  options:[
    ...
    "La solubilità massima del soluto in g/L",
    "La conducibilità elettrica assoluta della soluzione",
    "Il numero di ioni prodotti da ciascuna formula unitaria"], correct:0 },
...
{ id:"sol-06", topic:"soluzioni", type:"mc",
  ...
  options:[
    "La solubilità del sale in acqua",
    "Il numero di ioni in cui si dissocia una singola formula unitaria del sale",
    "Il grado di dissociazione percentuale",
    "La massa molare del sale",
    "Il coefficiente isotonico della soluzione"], correct:1,
...
{ id:"sol-19", topic:"soluzioni", type:"mc",
  ...
  options:[
    "90 mosM",
    "616 mosM, ipertonica al plasma",
    "900 mosM",
    "308 mosM, sostanzialmente isotonica al plasma",
    "154 mosM, ipotonica al plasma"], correct:3,
...
{ id:"sol-22", topic:"soluzioni", type:"mc",
  ...
  options:[
    "Plasmolisi: raggrinzimento per uscita netta di acqua",
    "Emolisi: rottura della cellula per rigonfiamento, causato dall'ingresso netto di acqua",
    "Solidificazione della membrana",
    "Nessuna variazione di volume",
    "Un aumento dell'osmolarità intracellulare"], correct:1 },
...
{ id:"sol-23", topic:"soluzioni", type:"mc",
  ...
  options:[
    "Emolisi: rottura per rigonfiamento",
    "Nessuna variazione di volume",
    "Plasmolisi: raggrinzimento della cellula per uscita netta di acqua",
    "Un aumento del volume cellulare",
    "La fusione con altre cellule"], correct:2 },
...
{ id:"sol-27", topic:"soluzioni", type:"mc",
  ...
  options:[
    "Dalla massa molare del solvente",
    "Solo dal volume del solvente",
    "Solo dalla temperatura della soluzione",
    "Esclusivamente dalla natura chimica del soluto",
...
{ id:"sol-33", topic:"soluzioni", type:"mc",
  ...
  options:[
    "Il passaggio di soluto attraverso una membrana, indipendentemente dal solvente",
    "Il passaggio di ioni attraverso canali proteici",
    ...
    "Un tipo di diffusione che riguarda solo i gas",
    "La formazione di un precipitato in soluzione"], correct:2 },
...
{ id:"sol-36", topic:"soluzioni", type:"mc",
  ...
  options:[
    ...
    "La pressione di vapore del solvente puro",
    "La pressione osmotica delle sole proteine plasmatiche",
    "La pressione atmosferica esercitata sulla soluzione",
    "La pressione a cui avviene l'ebollizione della soluzione"], correct:0 },
...
{ id:"sol-37", topic:"soluzioni", type:"mc",
  ...
  options:[
    ...
    "Un aumento della pressione osmotica stessa",
    "La precipitazione del soluto",
    "L'aumento della tensione di vapore"], correct:1 },
...
{ id:"sol-38", topic:"soluzioni", type:"mc",
  ...
  options:[
    ...
    "Ai globuli rossi in sospensione",
    "A tutti i soluti plasmatici, inclusi gli elettroliti",
    "Alla componente gassosa disciolta nel plasma",
    "Esclusivamente al glucosio ematico"], correct:0 },
...
{ id:"sol-39", topic:"soluzioni", type:"mc",
  ...
  options:[
    ...
    "Una reazione chimica di neutralizzazione acido-base",
    "L'elettrolisi dell'acqua plasmatica",
    "La sola forza di gravità, senza membrane"], correct:0 },
...
{ id:"sol-42", topic:"soluzioni", type:"mc",
  ...
  options:[
    "Per metà nel liquido intracellulare",
    "Il 15% nel liquido interstiziale e il 5% nel liquido plasmatico",
    "Il 5% interstiziale e il 15% plasmatico",
    "Interamente nel liquido interstiziale",
    "Interamente nel plasma"], correct:1 },
...
{ id:"sol-44", topic:"soluzioni", type:"mc",
  ...
  options:[
    "Coesistono più fasi distinguibili",
    "Non può contenere sali disciolti",
    "Si presenta come un'unica fase, con composizione identica in ogni suo punto",
    "È sempre allo stato liquido",
    "Contiene un solo componente puro"], correct:2 },
...
{ id:"sol-46", topic:"soluzioni", type:"mc",
  ...
  options:[
    "Sempre nullo",
    "Compreso tra 1 nm e 1 µm",
    "Uguale a quello delle molecole di solvente",
    "Maggiore di 1 µm, separabili per gravità",
    "Minore di 1 nm"], correct:3 },
...
{ id:"sol-47", topic:"soluzioni", type:"mc",
  ...
  options:[
    "Sempre maggiore di 1 µm",
    "Uguale a quello degli ioni",
    "Sempre minore di 1 nm",
    "Minore di 1 µm e maggiore di 1 nm, che non sedimentano",
    "Non misurabile"], correct:3 },
...
{ id:"sol-52", topic:"soluzioni", type:"mc",
  ...
  options:[
    "L'assenza di legami a idrogeno",
    "La sua elevata costante dielettrica e alla capacità di idratare le particelle di soluto",
    "La sua bassa capacità termica",
    "La sua elevata viscosità",
    "La sua bassa polarità"], correct:1 },

{ id:"sol-53", topic:"soluzioni", type:"mc",
  q:"La solubilità di un soluto è definita come:",
  options:[
    "La densità di una soluzione",
    "Il numero di legami covalenti nel soluto",
    "La velocità con cui un soluto si scioglie",
...
{ id:"sol-54", topic:"soluzioni", type:"mc",
  ...
  options:[
    "Non può più essere diluita",
    "È sempre a temperatura ambiente",
    "Contiene disciolta la massima quantità di soluto possibile a quella temperatura",
    "Non contiene alcun soluto",
    "Contiene soltanto soluti gassosi"], correct:2 },

{ id:"sol-55", topic:"soluzioni", type:"mc",
  q:"La solubilità di un soluto in un dato solvente dipende da:",
  options:[
    "Solo dal volume del recipiente",
    "Solo dal colore della soluzione",
    "Esclusivamente dalla massa molare del solvente",
    "Natura di soluto e solvente, temperatura e, per i soluti gassosi, pressione",
    "Esclusivamente dal pH"], correct:3 },
...
{ id:"sol-56", topic:"soluzioni", type:"mc",
  ...
  options:[
    ...
    "Diminuisce sempre con la temperatura",
    "Aumenta solo se il soluto è un elettrolita",
    "Dipende solo dalla pressione",
    "È indipendente dalla temperatura"], correct:0,
...
{ id:"sol-58", topic:"soluzioni", type:"mc",
  ...
  options:[
    "La legge si applica solo ai liquidi puri",
    "La quantità di un gas che si scioglie in un liquido è direttamente proporzionale alla pressione parziale del gas",
    "La solubilità di un gas è indipendente dalla pressione",
    "La solubilità di un gas diminuisce all'aumentare della pressione",
    "Solo i gas nobili obbediscono a questa legge"], correct:1 },
...
{ id:"sol-59", topic:"soluzioni", type:"mc",
  ...
  options:[
    "In un'acidosi metabolica improvvisa",
    "In una crisi ipoglicemica",
    "Nell'embolia gassosa, per formazione di bolle di azoto nel sangue",
    "In un aumento della pressione osmotica plasmatica",
    "In una disidratazione acuta"], correct:2 },
...
{ id:"sol-60", topic:"soluzioni", type:"mc",
  ...
  options:[
    "È un gas molto pesante",
    "È completamente insolubile in acqua pura",
    "Non obbedisce alle leggi dei gas",
    "Si lega covalentemente all'emoglobina come l'ossigeno",
...
{ id:"sol-61", topic:"soluzioni", type:"mc",
  ...
  options:[
    "Il prodotto delle pressioni parziali",
    "La pressione parziale del gas più abbondante",
    "Indipendente dalla composizione della miscela",
    "Sempre uguale a 1 atm",
...
{ id:"sol-62", topic:"soluzioni", type:"mc",
  ...
  options:[
    "Il numero totale di moli della miscela",
    "La sua massa molare",
...
{ id:"sol-64", topic:"soluzioni", type:"mc",
  ...
  options:[
    ...
    "Solo per trasporto attivo ATP-dipendente",
    ...
    "In modo indipendente dalla pressione parziale dei gas",
    "Esclusivamente per osmosi"], correct:2 },

{ id:"sol-65", topic:"soluzioni", type:"mc",
  q:"La frazione molare $X_A$ di un componente A in una soluzione è definita come:",
  options:[
    "Il rapporto tra le moli di A e i grammi di solvente",
    "Il rapporto tra la massa di A e quella del solvente puro",
    "Il rapporto tra le moli di A e le moli totali di tutti i componenti della soluzione",
    "Sempre uguale a 1 per ogni componente",
    "Il rapporto tra i grammi di A e il volume totale"], correct:2 },
...
{ id:"sol-73", topic:"soluzioni", type:"mc",
  ...
  options:[
    "Presenti solo se il soluto è un elettrolita",
    "Sempre nulle",
    "Sempre più forti delle interazioni nei componenti puri",
    "Indipendenti dalla composizione della soluzione",
...
{ id:"sol-74", topic:"soluzioni", type:"mc",
  ...
  options:[
    "Della temperatura corporea troppo bassa",
    "Dell'assenza di membrane semipermeabili",
    "Della pressione atmosferica",
    "Dell'alta concentrazione di macromolecole e della limitata acqua libera",
    "Dell'assenza di elettroliti"], correct:3 },
...
{ id:"sol-75", topic:"soluzioni", type:"mc",
  ...
  options:[
    ...
    "La temperatura è 0 °C",
    "La soluzione è satura",
    "Il soluto è un elettrolita forte",
    "Il pH è neutro"], correct:0 },
...
{ id:"en-32", topic:"energia", type:"mc",
  ...
  options:[
    "Nulla",
    "Metà cinetica e metà potenziale",
    "Dipendente dalla massa del blocco",
    "Interamente cinetica",
...
{ id:"en-34", topic:"energia", type:"mc",
  ...
  options:[
    "Resta nulla",
    "Si conserva comunque",
    "Si conserva solo se il corpo è fermo",
    "Aumenta sempre",
...
{ id:"qm-04", topic:"quantita_moto", type:"mc",
  ...
  options:[
    ...
    "La variazione di velocità, indipendentemente dalla massa",
    "Il lavoro compiuto dalla forza",
    "Zero, sempre",
    "La variazione di energia cinetica del corpo"], correct:0 },
...
{ id:"qm-06", topic:"quantita_moto", type:"mc",
  ...
  options:[
    ...
    "Della legge di Hooke"], correct:0 },
...
{ id:"qm-08", topic:"quantita_moto", type:"mc",
  ...
  options:[
    "Le masse di A e B devono essere uguali",
    "Le velocità di A e B restano sempre costanti",
    "L'energia cinetica di A è sempre uguale a quella di B",
    "La variazione della quantità di moto di A è uguale e opposta a quella di B: $\\Delta q_A+\\Delta q_B=0$",
    "A e B non possono mai interagire"], correct:3 },
...
{ id:"qm-09", topic:"quantita_moto", type:"mc",
  ...
  options:[
    ...
    "Nessuna delle due grandezze si conserva",
    "Si conserva solo l'energia cinetica, non la quantità di moto",
    "I due corpi restano uniti dopo l'urto",
    "L'energia cinetica totale aumenta"], correct:0 },

{ id:"qm-10", topic:"quantita_moto", type:"mc",
  q:"Un urto tra due corpi si definisce anelastico quando:",
  options:[
    "I due corpi si respingono a distanza infinita",
    "Nessuna delle due grandezze si conserva",
    ...
    "Sia la quantità di moto sia l'energia cinetica si conservano",
    "Si conserva solo l'energia cinetica"], correct:2 },
...
{ id:"qm-17", topic:"quantita_moto", type:"mc",
  ...
  options:[
    ...
    "Il centro di massa non accelera mai",
    "$\\sum_i \\vec{F}_i = 0$ sempre, indipendentemente dalle forze esterne",
    "$\\sum_i \\vec{F}_i = m_i\\vec{a}_{CM}$",
    "Il centro di massa si muove solo se tutte le forze interne sono nulle"], correct:0,
...
{ id:"cr-01", topic:"corpirigidi", type:"mc",
  ...
  options:[
    "Privo di massa",
    "Che si deforma sempre sotto l'azione di una forza",
    "Privo di volume",
    "La cui forma e le cui dimensioni non cambiano, indipendentemente dalle forze applicate",
    "Che può esistere solo allo stato gassoso"], correct:3 },
...
{ id:"cr-02", topic:"corpirigidi", type:"mc",
  ...
  options:[
    ...
    "I punti descrivono traiettorie circolari attorno a un asse",
    "Ogni punto ha una velocità diversa in base alla distanza dall'asse",
    "La velocità angolare è la stessa per tutti i punti",
    "Solo il centro di massa si muove, gli altri punti restano fermi"], correct:0 },

{ id:"cr-03", topic:"corpirigidi", type:"mc",
  q:"Nel moto rotatorio di un corpo rigido attorno a un asse fisso:",
  options:[
    "La velocità angolare dipende dalla distanza dall'asse",
    "Tutti i punti hanno la stessa velocità lineare",
    "I punti più vicini all'asse hanno velocità lineare maggiore",
    ...
    "Non esiste un asse di rotazione definito"], correct:3 },
...
{ id:"cr-04", topic:"corpirigidi", type:"mc",
  ...
  options:[
    ...
    "$\\vec{M}=m\\vec{r}$",
    "$\\vec{M}=F/r$",
    "$\\vec{M}=\\vec{r}\\cdot\\vec{F}$ (prodotto scalare)",
    "$\\vec{M}=\\vec{r}+\\vec{F}$"], correct:0 },
...
{ id:"cr-06", topic:"corpirigidi", type:"mc",
  ...
  options:[
    "La distanza r è minore",
    "La distanza r dal punto di applicazione all'asse di rotazione (braccio) è maggiore",
    "Il corpo è più massiccio",
    "La forza è applicata parallelamente al braccio",
    "La forza è nulla"], correct:1 },
...
{ id:"cr-08", topic:"corpirigidi", type:"mc",
  ...
  options:[
    "Ha le stesse unità di misura della quantità di moto",
    "È una grandezza vettoriale",
    "Dipende dalla distribuzione della massa rispetto all'asse e dalla scelta dell'asse stesso",
    "È indipendente dalla scelta dell'asse di rotazione",
    "Dipende solo dalla massa totale, non dalla sua distribuzione"], correct:2 },
...
{ id:"cr-15", topic:"corpirigidi", type:"mc",
  ...
  options:[
    "Solo la somma dei momenti delle forze",
    "La somma vettoriale di tutte le forze applicate e la somma vettoriale dei loro momenti",
    "Solo l'accelerazione angolare",
    "Solo la somma delle forze applicate",
    "Solo il momento di inerzia del corpo"], correct:1 },

{ id:"cr-16", topic:"corpirigidi", type:"mc",
  q:"Una leva è schematizzabile come:",
  options:[
    "Una molla ideale priva di massa",
    ...
    "Un sistema privo di punti fissi",
    "Un fluido in equilibrio idrostatico",
    "Un corpo in caduta libera"], correct:1 },
...
{ id:"cr-18", topic:"corpirigidi", type:"mc",
  ...
  options:[
    ...
    "Uguale a 0",
    "Uguale a 1",
    "Sempre negativo"], correct:0 },

{ id:"cr-19", topic:"corpirigidi", type:"mc",
  q:"Nelle leve di primo genere, il fulcro si trova:",
  options:[
    "Mai tra le due forze",
    "In posizione intermedia tra la forza motrice e quella resistente",
    "Tra le due forze solo se la leva è svantaggiosa",
    "Sempre a un'estremità della leva",
    "Sempre a coincidere con il punto di applicazione della resistenza"], correct:1 },
...
{ id:"cr-20", topic:"corpirigidi", type:"mc",
  ...
  options:[
    ...
    "Forza motrice",
    "Asse di simmetria, privo di funzione meccanica",
    "Contrappeso"], correct:1 },
...
{ id:"cr-24", topic:"corpirigidi", type:"mc",
  ...
  options:[
    ...
    "$\\varepsilon=E\\sigma^2$",
    "$E=\\sigma+\\varepsilon$",
    "$\\sigma=k\\varepsilon^2$"], correct:1 },

{ id:"cr-25", topic:"corpirigidi", type:"mc",
  q:"Una deformazione si dice elastica quando:",
  options:[
    "Avviene solo nei liquidi",
    "È indipendente dal limite elastico del materiale",
    "Il corpo ritorna alla forma originale dopo la rimozione della forza applicata (deformazione reversibile)",
    "Il corpo resta permanentemente deformato",
    "Il materiale si rompe immediatamente"], correct:2 },
